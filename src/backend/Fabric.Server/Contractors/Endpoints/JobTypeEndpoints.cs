...
public static class JobTypeEndpoints
{
    public static IEndpointRouteBuilder MapJobTypeEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        jobTypes.MapGet("", ListJobTypes)
            ...
            .RequireAuthorization(new AuthorizeAttribute { Roles = $"{FabricRoleDefaults.AdminRole},{FabricRoleDefaults.ContractorEnrollmentRole},{FabricRoleDefaults.ContractorPlanningRole}" })
        ...
        jobTypes.MapPost("", CreateJobType)
            ...
            .RequireAuthorization(new AuthorizeAttribute { Roles = $"{FabricRoleDefaults.AdminRole},{FabricRoleDefaults.ContractorEnrollmentRole}" })
