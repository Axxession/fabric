...
{
    /// <inheritdoc />
    public partial class RefactorRequirementsLocationPolicies : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "location_job_requirement_policies",
                schema: "requirements",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_location_job_requirement_policies", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "location_requirement_policies",
                schema: "requirements",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_location_requirement_policies", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_location_job_requirement_policies_tenant_id",
                schema: "requirements",
                table: "location_job_requirement_policies",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_location_job_requirement_policies_tenant_id_location_id_job_type_id_requirement_definition_id",
                schema: "requirements",
                table: "location_job_requirement_policies",
                columns: new[] { "tenant_id", "location_id", "job_type_id", "requirement_definition_id" });

            migrationBuilder.CreateIndex(
                name: "ix_location_requirement_policies_tenant_id",
                schema: "requirements",
                table: "location_requirement_policies",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_location_requirement_policies_tenant_id_location_id_requirement_definition_id_subject_kind",
                schema: "requirements",
                table: "location_requirement_policies",
                columns: new[] { "tenant_id", "location_id", "requirement_definition_id", "subject_kind" });
        }
