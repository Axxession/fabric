...
public sealed record RequirementDefinitionResponse(Guid Id, string Code, string Name, string? Description, RequirementFulfillmentKind FulfillmentKind, bool IsSensitive, bool IsActive, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt);
...
public static class RequirementsMapper
{
    public static RequirementDefinitionResponse ToResponse(this RequirementDefinition definition) =>
        new(definition.Id, definition.Code, definition.Name, definition.Description, definition.FulfillmentKind, definition.IsSensitive, definition.IsActive, definition.CreatedAt, definition.UpdatedAt);
    ...
    public static LocationAttachedRequirementResponse ToAttachedRequirementResponse(this LocationRequirementPolicy policy, RequirementDefinition definition) =>
        new(policy.Id, policy.LocationId, policy.RequirementDefinitionId, definition.Code, definition.Name, definition.FulfillmentKind, definition.IsSensitive, policy.SubjectKind, policy.IsBlocking, policy.IsEnabled, policy.CreatedAt, policy.UpdatedAt);
    ...
    public static LocationJobAttachedRequirementResponse ToAttachedRequirementResponse(this LocationJobRequirementPolicy policy, RequirementDefinition definition) =>
        new(policy.Id, policy.LocationId, policy.JobTypeId, policy.RequirementDefinitionId, definition.Code, definition.Name, definition.FulfillmentKind, definition.IsSensitive, policy.IsBlocking, policy.IsEnabled, policy.CreatedAt, policy.UpdatedAt);
