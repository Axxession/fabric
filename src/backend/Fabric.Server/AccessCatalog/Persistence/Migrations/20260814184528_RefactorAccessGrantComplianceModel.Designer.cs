...
namespace Fabric.Server.AccessCatalog.Persistence.Migrations
{
    ...
    [Migration("20260814184528_RefactorAccessGrantComplianceModel")]
    partial class RefactorAccessGrantComplianceModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fabric.Server.AccessCatalog.Domain.AccessGrant", b =>
                {
                    ...
                    b.Property<Guid?>("RequestScopeId")
                        .HasColumnType("uuid")
                        .HasColumnName("request_scope_id");

                    b.Property<string>("RevokeCause")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("revoke_cause");
            ...
            modelBuilder.Entity("Fabric.Server.AccessCatalog.Domain.ApprovalFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_approval_flows_tenant_id");

                    b.HasIndex("TenantId", "AccessItemId", "SiteId")
                    ...
                    b.ToTable("approval_flows", "access_catalog");
                });
            ...
            modelBuilder.Entity("Fabric.Server.AccessCatalog.Domain.ApprovalRequirement", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ApprovalFlowId", "Status")
            ...
            modelBuilder.Entity("Fabric.Server.AccessCatalog.Domain.PackageRequestScope", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("RequestedLocationId")
                        .HasColumnType("uuid")
                        .HasColumnName("requested_location_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_package_request_scopes");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_package_request_scopes_tenant_id");

                    b.HasIndex("TenantId", "RequestId")
                        .HasDatabaseName("ix_package_request_scopes_tenant_id_request_id");

                    b.HasIndex("TenantId", "ApprovalFlowId", "RequestedLocationId")
                        .IsUnique()
                        .HasDatabaseName("ix_package_request_scopes_tenant_id_flow_location");

                    b.ToTable("package_request_scopes", "access_catalog");
                });

            modelBuilder.Entity("Fabric.Server.AccessCatalog.Domain.AccessGrant", b =>
                {
                    b.HasOne("Fabric.Server.AccessCatalog.Domain.ApprovalFlow", null)
                        .WithMany()
                    ...
                    b.HasOne("Fabric.Server.AccessCatalog.Domain.PackageRequestScope", null)
                        .WithMany()
                        .HasForeignKey("RequestScopeId")
                        .OnDelete(DeleteBehavior.SetNull)
