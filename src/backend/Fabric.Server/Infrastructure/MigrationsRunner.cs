...
public sealed class MigrationsRunner(IServiceScopeFactory scopeFactory)
{
    public async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        await new MigrationRunner<ContractorsDbContext>(services).RunMigrationsAsync(cancellationToken);
        ...
        await new MigrationRunner<LearningDbContext>(services).RunMigrationsAsync(cancellationToken);
