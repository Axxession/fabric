...
using System.Text;
using Fabric.Hardware.BelgianEid.Middleware.Delegates;
...
namespace Fabric.Hardware.BelgianEid.Middleware.Wrapper
{
    ...
    public class Pkcs11Module
    {
        ...
        public void InitToken(uint slotId, string pin, string label)
        {
            ...
            new List<byte>(Encoding.UTF8.GetBytes(label + new String(' ', 32))).CopyTo(0, labelBytes, 0, 32);
        ...
        public void SetPIN(uint hSession, string oldPin, string newPin)
        {
            ...
            checkCKR(proc(hSession, oldPinBytes, (uint)oldPinBytes.Length, newPinBytes, (uint)newPinBytes.Length));
        }
        ...
        {
            // TODO: Uncomment this if needed. Resharper removes the first two lines and renders the code not compilable
            // #if CDECL
        ...
        public KeyPairHandler GenerateKeyPair(uint hSession, CK_MECHANISM mech, CK_ATTRIBUTE[] pubKeyTemplate, CK_ATTRIBUTE[] privKeyTemplate)
        {
            ...
            checkCKR(
                proc.Invoke(
                    ...
                    ref mech,
                    pubKeyTemplate,
                    (uint)pubKeyTemplate.Length,
                    privKeyTemplate,
                    (uint)privKeyTemplate.Length,
                    ref kp.hPublicKey,
                    ref kp.hPrivateKey
                )
            );
