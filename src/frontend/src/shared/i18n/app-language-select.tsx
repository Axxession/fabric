...
export function AppLanguageSelect() {
  ...
  return (
    <label className="min-w-0">
      ...
      <select
        className="h-10 min-w-28 rounded-interactive border border-border bg-content px-3 text-[14px] font-medium text-foreground outline-none transition focus:border-primary"
