...
const desfireStudioMenuItems = [
  { label: 'Hardware Agents', description: 'Manage local DESFire-capable devices and diagnostics.', to: '/desfire-studio/hardware-agents' },
  { label: 'Key Management', description: 'Manage DESFire key groups and diversification strategies.', to: '/desfire-studio/key-management' },
  { label: 'Chip Designer', description: 'Build chip designs, transformations, and system providers.', to: '/desfire-studio/chip-designer' },
  { label: 'Printing', description: 'Schedule encoding batches, inspect runs, and bind encoders.', to: '/desfire-studio/printing' },
] as const;
    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 border-b border-border bg-content">
        <div className="flex items-center gap-3 px-3 py-3 sm:px-4 sm:py-4">
          <Link to="/desfire-studio" className="flex items-center gap-3" aria-label={`${branding.appName} DESFire Studio home`}>
            ...
            <div>
              ...
              <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">DESFire Studio</p>
            </div>
          </Link>
      ...
      <main className="min-w-0">
        <div className="flex min-h-[calc(100vh-73px)] items-stretch">
          <aside className="flex w-80 shrink-0 flex-col border-r border-border bg-content p-4 md:sticky md:top-[73px] md:h-[calc(100vh-73px)]">
            ...
            <nav aria-label="DESFire Studio navigation" className="mt-3 grid gap-2">
