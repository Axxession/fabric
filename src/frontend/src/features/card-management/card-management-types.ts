...
export type BadgeBatch = components['schemas']['BadgeBatchResponse'];
export type CreateBadgeBatchRequest = components['schemas']['CreateBadgeBatchRequest'];
export type BadgeJob = components['schemas']['BadgeJobResponse'];
export type BadgeJobStatus = components['schemas']['BadgeJobStatus'];
export type BadgeBatchStatus = components['schemas']['BadgeBatchStatus'];
export type CreateBadgeJobRequest = components['schemas']['CreateBadgeJobRequest'];
